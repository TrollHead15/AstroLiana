...
export const ChecklistForm: React.FC<ChecklistFormProps> = ({ isOpen, onClose }) => {
  ...
  const onSubmit = async (data: ChecklistGuideFormData) => {
    ...
    try {
      ...
      toast.success('Чек-лист отправлен на вашу почту!');
      reset();
      onClose();
    } catch (error) {
  ...
  return (
    <LeadMagnetModal isOpen={isOpen} onClose={handleClose} title="Получить чек-лист">
